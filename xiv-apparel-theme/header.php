...
<header class="xiv-sticky xiv-top-0 xiv-z-40 xiv-bg-xiv-bg/95 xiv-backdrop-blur xiv-border-b xiv-border-xiv-gray-light">
	<div class="xiv-max-w-7xl xiv-mx-auto xiv-px-4 sm:xiv-px-6 xiv-h-16 xiv-flex xiv-items-center xiv-justify-between xiv-gap-4">
		...
		<button type="button" class="xiv-mobile-nav-toggle xiv-p-2 -xiv-ml-2 xiv-text-xiv-black lg:xiv-hidden" aria-expanded="false" aria-controls="xiv-mobile-menu" aria-label="<?php xiv_et( 'Open menu' ); ?>">
		...
		<div class="xiv-flex xiv-items-center xiv-gap-1 sm:xiv-gap-3">
			<?php if ( function_exists( 'xiv_language_switcher' ) ) : ?>
				<div class="xiv-hidden sm:xiv-block xiv-mr-1"><?php xiv_language_switcher(); ?></div>
			<?php endif; ?>

			<button type="button" class="xiv-search-toggle xiv-p-2 xiv-text-xiv-black" aria-expanded="false" aria-label="<?php xiv_et( 'Search' ); ?>">
			...
			<a href="<?php echo esc_url( get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ) ?: home_url( '/' ) ); ?>" class="xiv-p-2 xiv-text-xiv-black" aria-label="<?php xiv_et( 'My account' ); ?>">
			...
			<a href="<?php echo esc_url( function_exists( 'xiv_wishlist_url' ) ? xiv_wishlist_url() : home_url( '/' ) ); ?>" class="xiv-relative xiv-p-2 xiv-text-xiv-black" aria-label="<?php xiv_et( 'Wishlist' ); ?>">
				<svg class="xiv-w-5 xiv-h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M12 20.5s-7.5-4.7-7.5-10A4.5 4.5 0 0 1 12 6.4a4.5 4.5 0 0 1 7.5 4.1c0 5.3-7.5 10-7.5 10Z" stroke-linejoin="round"/></svg>
				<?php $xiv_wishlist_count = function_exists( 'xiv_wishlist_count' ) ? xiv_wishlist_count() : 0; ?>
				<?php if ( $xiv_wishlist_count > 0 ) : ?>
					<span class="xiv-wishlist-count xiv-absolute -xiv-top-0.5 -xiv-right-0.5 xiv-bg-xiv-blue-accent xiv-text-white xiv-w-4 xiv-h-4 xiv-rounded-full xiv-flex xiv-items-center xiv-justify-center xiv-text-[10px] xiv-font-bold"><?php echo esc_html( $xiv_wishlist_count ); ?></span>
				<?php else : ?>
					<span class="xiv-wishlist-count xiv-absolute -xiv-top-0.5 -xiv-right-0.5 xiv-bg-xiv-blue-accent xiv-text-white xiv-w-4 xiv-h-4 xiv-rounded-full xiv-flex xiv-items-center xiv-justify-center xiv-text-[10px] xiv-font-bold xiv-hidden">0</span>
				<?php endif; ?>
			</a>

			<a href="<?php echo esc_url( function_exists( 'xiv_compare_url' ) ? xiv_compare_url() : home_url( '/' ) ); ?>" class="xiv-relative xiv-p-2 xiv-text-xiv-black" aria-label="<?php xiv_et( 'Compare' ); ?>">
				<svg class="xiv-w-5 xiv-h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true"><path d="M4 7h10m0 0-3-3m3 3-3 3M20 17H10m0 0 3-3m-3 3 3 3" stroke-linecap="square"/></svg>
				<?php $xiv_compare_count = function_exists( 'xiv_compare_count' ) ? xiv_compare_count() : 0; ?>
				<span class="xiv-compare-count xiv-absolute -xiv-top-0.5 -xiv-right-0.5 xiv-bg-xiv-blue-accent xiv-text-white xiv-w-4 xiv-h-4 xiv-rounded-full xiv-flex xiv-items-center xiv-justify-center xiv-text-[10px] xiv-font-bold <?php echo $xiv_compare_count > 0 ? '' : 'xiv-hidden'; ?>"><?php echo esc_html( $xiv_compare_count ); ?></span>
			</a>

			<?php if ( class_exists( 'WooCommerce' ) ) : ?>
			<button type="button" class="xiv-cart-toggle xiv-relative xiv-p-2 xiv-text-xiv-black" aria-label="<?php xiv_et( 'Open shopping bag' ); ?>">
	...
	<div id="xiv-search-overlay" class="xiv-hidden xiv-border-t xiv-border-xiv-gray-light xiv-bg-xiv-bg">
		<form role="search" method="get" class="xiv-max-w-7xl xiv-mx-auto xiv-px-4 sm:xiv-px-6 xiv-py-6" action="<?php echo esc_url( home_url( '/' ) ); ?>">
			<label class="xiv-sr-only" for="xiv-search-input"><?php xiv_e( 'Search products' ); ?></label>
			<div class="xiv-flex xiv-items-center xiv-gap-3 xiv-border-b xiv-border-xiv-black xiv-pb-2">
				...
				<input id="xiv-search-input" type="search" name="s" placeholder="<?php xiv_et( 'SEARCH COLLECTION' ); ?>" autocomplete="off"
				...
				<button type="submit" class="xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-text-xiv-black"><?php xiv_e( 'GO' ); ?></button>
			</div>
			<div id="xiv-live-search-results" class="xiv-relative" aria-live="polite"></div>
		</form>
	</div>
</header>
