...
<header class="xiv-py-6 md:xiv-py-10">
	...
	<p class="xiv-result-count xiv-text-xs xiv-font-mono xiv-text-xiv-gray-text xiv-uppercase xiv-mt-3">
		<?php
		global $wp_query;
		printf( esc_html__( '%s PRODUCTS', 'xiv-apparel' ), esc_html( number_format_i18n( $wp_query->found_posts ) ) );
		?>
	</p>
</header>
...
<div class="xiv-grid xiv-gap-8 lg:xiv-grid-cols-[240px_1fr]">
	...
	<aside class="xiv-filter-panel xiv-relative xiv-z-20">
		<button type="button" class="xiv-filter-open lg:xiv-hidden xiv-w-full xiv-bg-xiv-black xiv-text-white xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-py-3 xiv-px-4 xiv-flex xiv-items-center xiv-justify-between xiv-mb-4">
			<span><?php esc_html_e( 'FILTERS', 'xiv-apparel' ); ?></span><span aria-hidden="true">&rarr;</span>
		</button>
		...
		<form id="xiv-filter-form" class="xiv-filter-body xiv-fixed xiv-inset-0 xiv-z-40 xiv-hidden lg:xiv-static lg:xiv-block lg:xiv-z-auto lg:xiv-bg-transparent" method="get" action="<?php echo esc_url( wc_get_page_permalink( 'shop' ) ); ?>">
			<div class="xiv-h-full xiv-bg-xiv-bg xiv-shadow-xl lg:xiv-shadow-none xiv-p-6 lg:xiv-p-0 xiv-flex xiv-flex-col xiv-overflow-y-auto">
				<div class="lg:xiv-hidden xiv-flex xiv-items-center xiv-justify-between xiv-mb-4">
					<span class="xiv-text-sm xiv-font-black xiv-uppercase"><?php esc_html_e( 'FILTERS', 'xiv-apparel' ); ?></span>
					<button type="button" class="xiv-filter-close xiv-p-2" aria-label="<?php esc_attr_e( 'Close filters', 'xiv-apparel' ); ?>">
				...
				<div class="xiv-space-y-6 xiv-text-sm">
					...
					<!-- Availability -->
					<fieldset>
						<legend class="xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-mb-2"><?php esc_html_e( 'AVAILABILITY', 'xiv-apparel' ); ?></legend>
						<label class="xiv-flex xiv-items-center xiv-gap-2 xiv-cursor-pointer">
							...
							<span class="xiv-text-xs xiv-text-xiv-gray-text xiv-uppercase"><?php esc_html_e( 'All', 'xiv-apparel' ); ?></span>
						</label>
						<label class="xiv-flex xiv-items-center xiv-gap-2 xiv-cursor-pointer">
							<input type="radio" name="availability" value="in_stock" class="xiv-accent-xiv-black">
							<span class="xiv-text-xs xiv-text-xiv-gray-text xiv-uppercase"><?php esc_html_e( 'In Stock', 'xiv-apparel' ); ?></span>
						</label>
					</fieldset>
					...
					<?php if ( $xiv_has_filter ) : $xiv_sizes = get_terms( array( 'taxonomy' => 'pa_size', 'hide_empty' => true, 'orderby' => 'menu_order' ) ); ?>
						...
						<!-- Size -->
						<fieldset>
							<legend class="xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-mb-2"><?php esc_html_e( 'SIZE', 'xiv-apparel' ); ?></legend>
					...
					<?php if ( ! is_wp_error( $xiv_cats ) && ! empty( $xiv_cats ) ) : ?>
						<fieldset>
							<legend class="xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-mb-2"><?php esc_html_e( 'CATEGORY', 'xiv-apparel' ); ?></legend>
					...
					<!-- Price Range -->
					<fieldset>
						<legend class="xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-mb-2"><?php esc_html_e( 'PRICE', 'xiv-apparel' ); ?></legend>
						<div class="xiv-grid xiv-grid-cols-2 xiv-gap-2">
							<input type="number" name="min_price" min="0" placeholder="<?php esc_attr_e( 'MIN', 'xiv-apparel' ); ?>"
							...
							<input type="number" name="max_price" min="0" placeholder="<?php esc_attr_e( 'MAX', 'xiv-apparel' ); ?>"
								   class="xiv-w-full xiv-p-2 xiv-text-xs xiv-bg-transparent xiv-border xiv-border-xiv-gray-light focus:xiv-border-xiv-black focus:xiv-outline-none" />
						</div>
					</fieldset>
					...
					<div class="lg:xiv-hidden">
						<button type="submit" class="xiv-w-full xiv-bg-xiv-black xiv-text-white xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-py-3">
							<?php esc_html_e( 'APPLY FILTERS', 'xiv-apparel' ); ?>
						</button>
					</div>
				</div>
			</div>
	...
	<!-- Products -->
	<section aria-label="<?php esc_attr_e( 'Products', 'xiv-apparel' ); ?>">
		<div class="xiv-flex xiv-items-center xiv-justify-between xiv-mb-6">
			...
			<select name="orderby" class="xiv-catalog-orderby xiv-bg-transparent xiv-border xiv-border-xiv-gray-light xiv-text-xs xiv-font-bold xiv-uppercase xiv-tracking-widest xiv-px-3 xiv-py-2 focus:xiv-outline-none focus:xiv-border-xiv-black" aria-label="<?php esc_attr_e( 'Sort products', 'xiv-apparel' ); ?>">
				<option value="menu_order"><?php esc_html_e( 'DEFAULT', 'xiv-apparel' ); ?></option>
				<option value="date"><?php esc_html_e( 'NEWEST', 'xiv-apparel' ); ?></option>
				<option value="price"><?php esc_html_e( 'PRICE: LOW TO HIGH', 'xiv-apparel' ); ?></option>
				<option value="price-desc"><?php esc_html_e( 'PRICE: HIGH TO LOW', 'xiv-apparel' ); ?></option>
				<option value="popularity"><?php esc_html_e( 'POPULARITY', 'xiv-apparel' ); ?></option>
			</select>
		</div>
