...
if ( wc_get_page_id( 'shop' ) > 0 ) : ?>
	<div class="return-to-shop xiv-flex xiv-flex-col xiv-items-center xiv-text-center xiv-py-24">
		<p class="xiv-font-display xiv-text-2xl xiv-font-extrabold xiv-uppercase xiv-tracking-tighter xiv-mb-3"><?php echo esc_html( xiv_t( 'Your bag is empty' ) ); ?></p>
		<p class="xiv-text-sm xiv-text-xiv-gray-text xiv-mb-8 xiv-max-w-md"><?php echo esc_html( xiv_t( 'Looks like you have not added anything yet. Browse the collection and find your next piece.' ) ); ?></p>
